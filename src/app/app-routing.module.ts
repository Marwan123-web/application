...
const routes: Routes = [
  ...
  {
    path: 'settings/scan-beacon',
    loadChildren: () => import('./scan-beacon/scan-beacon.module').then(m => m.scanBeaconPageModule),
    canActivate: [AuthGuard],
    data: { roles: [Role.Admin, Role.Teacher, Role.Student] }
  },
  {
    path: 'settings/scan-bluetooth',
    loadChildren: () => import('./scan-bluetooth/scan-bluetooth.module').then(m => m.scanBluetoothPageModule),
    canActivate: [AuthGuard],
    data: { roles: [Role.Admin, Role.Teacher, Role.Student] }
  },
  {
